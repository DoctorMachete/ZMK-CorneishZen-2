...
#define __ALT_R__    &ht_hrm LALT R
#define __CTL_S__    &ht_hrm LCTRL S
#define __WIN_T__    &ht_hrm LWIN T
#define __WIN_N__    &ht_hrm LWIN N
#define __CTL_E__    &ht_hrm LCTRL E
#define __ALT_I__    &ht_hrm LALT I
